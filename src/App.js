  ...
  return (
    ...
    <div className="App">
      <header className='header'>
        <img src="https://images.unsplash.com/photo-1604148482093-d55d6fc62400?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="banana" id='logoImg'/>
        <h1 id='title'>Banana Bank</h1>
        <p className='saldo'>Dein Girokonto:{count}</p>
